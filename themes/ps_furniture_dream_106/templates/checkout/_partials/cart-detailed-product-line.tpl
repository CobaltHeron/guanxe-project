  ...
  <div class="product-line-grid-right product-line-actions col-md-5 col-xs-12">
    <div class="row">
      ...
      <div class="col-md-10 col-xs-7">
        <div class="row">
          <div class="col-md-6 col-xs-6 qty tv-addtocart-qyt">
          ...
          <div class="col-md-6 col-xs-6 tv-addtocart-price price">
      ...
      <div class="col-md-2 col-xs-1 text-xs-right tv-cart-delete-icon-wrapper">
