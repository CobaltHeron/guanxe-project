...
<div class="tvproduct-wrapper {$class_name}">
		...
		<div class="tvproduct-image">
			{if $product.cover}
				<a href="{$product.url}" class="thumbnail product-thumbnail">
					<img src = "{$product.cover.bySize[$image_size]['url']}" alt = "{if !empty($product.cover.legend)}{$product.cover.legend}{else}{$product.name}{/if}" data-full-size-image-url = "{$product.cover.large.url}" class="tvproduct-defult-img">

					{if isset($product.images.0.bySize[$image_size]['url']) && empty($product.images.0.cover)}
						<img class="tvproduct-hover-img" src="{$product.images.0.bySize[$image_size]['url']}" alt="{$product.name}">
					{elseif isset($product.images.1.bySize[$image_size]['url']) && empty($product.images.1.cover)}
						<img class="tvproduct-hover-img" src="{$product.images.1.bySize[$image_size]['url']}" alt="{$product.name}">
					{/if}
				</a>
			{else}
				<a href="{$product.url}" class="thumbnail product-thumbnail">
	...
	<div class="tvproduct-info-box-wrapper">
		...
		<div class="tv-product-hover-info-box">
