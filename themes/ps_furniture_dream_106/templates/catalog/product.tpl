      ...
      {if $accessories}
        <div class="tvcmslike-product container-fluid">
            <div class='tvlike-product-wrapper-box container'>
                <div class="tvlike-product-all-box">
                    <div class="tvlike-product-content">
                        <div class="tvall-block-box-shadows">
                            <div class="tvlike-main-title-wrapper">
                        ...
                        <div class="tvfeature-pagination">
                            <div class="tvcmslike-pagination">
                                <div class="tvcmslike-next-pre-btn tvcms-next-pre-btn">
                                    <div class="tvcmslike-prev" data-parent="tvcmslike-product">
                                      <i class='material-icons'>&#xe5c4;</i>
                                      <span>{l s='Prev' d='Shop.Theme.Catalog'}</span>
                                    </div>
                                    <div class="tvcmslike-next" data-parent="tvcmslike-product">
                                      <i class='material-icons'>&#xe5c8;</i>
