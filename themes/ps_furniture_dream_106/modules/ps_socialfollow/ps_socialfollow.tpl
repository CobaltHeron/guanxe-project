...
{block name='block_social'}
  <div class="block-social tvcmsfooter-social-icon col-xl-4 col-md-4 col-sm-12">

    {*<div class="tvfooter-title-wrapper" data-target="#footer_sub_menu_social_icon" data-toggle="">
