						...
						<div class="tvnewsleeter-input-button-wraper">
							...
							<div class="tvnewsleteer-btn-wrapper">
								<button class='btn btn-primary' name="submitNewsletter" type="submit">
									<span class='tvnewslatter-btn-title hidden-xs-down'>{l s='Subscribe' d='Shop.Theme.Actions'}</span>
									<span class='tvnewslatter-btn-title hidden-sm-up'>{l s='OK' d='Shop.Theme.Actions'}</span>
